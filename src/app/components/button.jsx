...
const ButtonLaid = ({
  ...
  const commonClasses =
    "flex justify-center items-center font-bold hover:opacity-90 transition-opacity";
    ...
    <>
      ...
      {type === "youtube" && (
        ...
        >
          ...
          />
          <path
            d="M6.9334 4.33321L8.60006 5.33321C9.20006 5.73321 9.20006 6.33321 8.60006 6.73321L6.9334 7.73321C6.26673 8.13321 5.7334 7.79988 5.7334 7.06654V5.06654C5.7334 4.19988 6.26673 3.93321 6.9334 4.33321Z"
            stroke="white"
            strokeMiterlimit="10"
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  return (
    <>
      ...
      <div className="flex" style={{ width: `${fullWidth}px` }}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="14"
          height="30"
