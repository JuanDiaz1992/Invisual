...
const ButtonLaid = ({
  ...
  const isLink = link && link !== "#" && type !== "file" && type !== "submit";
  ...
  // CAMBIO 1: Eliminé el hover básico y añadí una transición suave al background
  const commonClasses =
    "flex justify-center items-center font-bold transition-all duration-300";

  // CAMBIO 2: Añadí clases de animación a los íconos (scale, rotate y bounce)
  // Usamos 'group-hover' para que reaccionen cuando se toca todo el botón
  const iconClasses = "me-2 transition-transform duration-300 ease-out group-hover:scale-125 group-hover:-rotate-6";
    ...
    <>
      {type === "file" && (
        <svg
          ...
          viewBox="0 0 11 22"
          fill="none"
          className={iconClasses} // Aplicamos la clase animada aquí
        >
      ...
      {type === "youtube" && (
        ...
        >
          <path
            d="M10.667 11.3337H4.00033C2.00033 11.3337 0.666992 10.0003 0.666992 8.00033V4.00033C0.666992 2.00033 2.00033 0.666992 4.00033 0.666992H10.667C12.667 0.666992 14.0003 2.00033 14.0003 4.00033V8.00033C14.0003 10.0003 12.667 11.3337 10.667 11.3337Z"
            stroke="white"
            strokeMiterlimit="10"
            strokeLinecap="round"
          ...
          />
          <path
            d="M6.9334 4.33321L8.60006 5.33321C9.20006 5.73321 9.20006 6.33321 8.60006 6.73321L6.9334 7.73321C6.26673 8.13321 5.7334 7.79988 5.7334 7.79988 7.06654V5.06654C5.7334 4.19988 6.26673 3.93321 6.9334 4.33321Z"
            stroke="white"
            strokeMiterlimit="10"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      {/* Texto también reacciona levemente */}
  ...
  return (
    <>
      ...
      {/* CAMBIO 3: Añadimos 'group' al contenedor padre y la animación de salto
          Esto hace que AMBAS partes (el SVG izquierdo y el botón principal) se muevan juntas */}
      <div
        className="flex group transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-1 hover:translate-x-[2px] hover:drop-shadow-lg"
      ...
      >
        ...
        >
          <path
            d="M6.49592 0L14 1.78814e-06L7.50407 30L0 30L6.49592 0Z"
            fill={buttonColor}
          />
        </svg>
