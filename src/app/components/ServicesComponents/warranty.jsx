...
export default function Warranty() {
  return (
    <section className="relative lg:mb-[100px]">
      <WarrantyImages />
      <div className="container mx-auto lg:max-w-[1300px] relative flex z-20">
        <div className="flex flex-wrap lg:w-full">
          ...
          <div className="lg:w-full justify-end flex lg:pt-12 pointer-events-none">
            <Image
      ...
      <div className="flex flex-wrap z-50 relative lg:ps-[10%]">
        ...
        <div className="lg:w-7/12 bg-[#1A1A1A] lg:-skew-x-12 relative overflow-hidden">
