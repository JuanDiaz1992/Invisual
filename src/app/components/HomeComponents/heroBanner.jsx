...
export default function HeroBanner() {
  return (
    <section id="home-hero-banner" className="md:mb-16 relative mb-[-50px] lg:mb-0">
      ...
      <div className="container lg:max-w-[1200px] mx-auto px-[24px] lg:px-0 pt-[45px] lg:pt-50 pb-8 relative">
        ...
        <div className="flex justify-end relative">
          <Image
            ...
            width={860}
            height={343}
            className="z-10 relative lg:w-[860px] lg:min-w-[400px] lg:me-[-190px] mt-5 lg:mt-[-250px] object-contain"
          />
        </div>
      </div>
      ...
      {/******* Red line bottom */}
      <div className="absolute lg:bottom-[0px] right-0 max-h-[65px] h-[65px] rotate-[165deg] overflow-hidden translate-x-[150px] translate-y-[70px] shadow-[-20px_-15px_20px_-12px_rgba(0,0,0,0.5)] z-10">
